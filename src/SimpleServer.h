...
struct EpollHandle {
    struct EventData {
        ...
        EventData() : _fd(0), _eventBuffer(), _bytesInBuffer(BUFFER_SIZE), _request(nullptr), _response(nullptr) {};
        EventData(int fd) : _fd(fd), _eventBuffer(), _bytesInBuffer(BUFFER_SIZE), _request(new HTTPRequest()), _response(new HTTPResponse()) {};
